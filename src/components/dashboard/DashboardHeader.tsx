    ...
    <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 p-6 bg-gray-50 rounded-xl shadow-neumorphic">
      ...
      <div className="mt-4 md:mt-0 flex items-center space-x-4">
        ...
        <Button 
          asChild 
          size="sm" 
          className="bg-gray-50 text-crisisBlue-600 hover:text-crisisBlue-700 shadow-neumorphic-sm hover:shadow-neumorphic-inset transition-shadow border-0 hover:bg-gray-50"
        >
